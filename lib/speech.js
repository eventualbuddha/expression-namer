...
const PREPOSITION = /(?:^|[a-z])(About|Above|Across|After|Against|Along|Among|Around|At|Before|Behind|Below|Beneigth|Beside|Besides|Between|Beyond|But|By|Down|During|Except|For|From|In|Inside|Into|Like|Near|Of|Off|On|Onto|Opposite|Out|Outside|Over|Past|Since|Through|To|Toward|Under|Underneigth|Until|Up|Upon|With|Within|Without)(?:[A-Z]|$)/;
